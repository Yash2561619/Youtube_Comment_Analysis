...
def evaluate_model(model, X_test: np.ndarray, y_test: np.ndarray):
  """Evaluate model and generate report and confusion matrix."""
  try:
...
def save_model_info(run_id: str, model_path: str, file_path: str) -> None:
  """Save the model run ID and path to JSON."""
  try:
...
def main():
  ...
  with mlflow.start_run() as run:
    try:
      ...
      logger.info("Loaded models and data successfully.")
      ...
      logger.info("Successfully generated model signature.")

      # Log model via mlflow.sklearn to handle pickled Scikit-Learn wrapper
